...
<body>
	<header class="section-bg py-2 text-center">
		<div class="container">
			<h3 class="title">Easy Installer by JVMMART</h3>
		</div>
	</header>
	<div class="installation-section padding-bottom padding-top">
		<div class="container">
			...
			$folderPermissions = [
				'laravel/bootstrap/cache/', 'laravel/storage/', 'laravel/storage/app/', '../laravel/storage/framework/', '../laravel/storage/logs/'
			];
			//------------->> Extension & Permission
...
";
										$status = 'ok';
										$envpath = dirname(__DIR__, 1) . '/laravel/.env';
										file_put_contents($envpath, $envcontent);
										if ($status == 'ok') {
											if(importDatabase($alldata)){							

   $conn = new PDO("mysql:host=$db_host;dbname=$db_name", $db_user, $db_pass);
   $query = file_get_contents("aviator.sql");
   ...
   $stmt->execute();						
				...
				<div class="installation-wrapper">
					<div class="install-content-area">
						<div class="install-item">
							<h3 class="title text-center">Installation Information Aviator</h3>
							<div class="box-item">
								<form action="?action=complete" method="post" class="information-form-area mb--20">
									...
									<div class="info-item">
										<h5 class="font-weight-normal mb-2">Purchase Verification | <a target="_blank" href="https://jvmmart.com">JVMMART.COM</a></h5>
										<div class="row">
	...
	<footer class="section-bg py-3 text-center">
		<div class="container">
			<p class="m-0 font-weight-bold">&copy;<?php echo Date('Y') ?> - All Right Reserved by <a href="https://jvmmart.com/">Jvmmart</a></p>
		</div>
	</footer>
	<style>
		#hide{
